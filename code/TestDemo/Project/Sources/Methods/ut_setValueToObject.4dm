...
$test:=AJ_UnitTest.new("setValueToObject"; Current method name:C684; "Utilities")
var $use : Object
$test.given:="undefined object"
$test.should:="return object with child"
$test.expected:=New object:C1471("child"; 2)
$test.actual:=setValueToObject($use; 2; "child")
$test.assert()
...
$test.actual:=setValueToObject($use; 4; "child")
$test.assert()
...
$test.actual:=setValueToObject($use; 5; "child"; "grandchild")
$test.assert()
...
$test.actual:=setValueToObject($use; 8; "child"; "grandchild")
$test.assert()
