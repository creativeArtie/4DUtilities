...
$test:=AJ_UnitTest.new("wk_setValueToObject"; Current method name:C684; "Utilities")
var $use : Object
$test.given:="undefined object"
$test.should:="return object with child"
$test.expected:=New object:C1471("child"; 2)
$test.actual:=wk_setValueToObject($use; 2; "child")
$test.assert()
...
$test.actual:=wk_setValueToObject($use; 4; "child")
$test.assert()
...
$test.actual:=wk_setValueToObject($use; 5; "child"; "grandchild")
$test.assert()
...
$test.actual:=wk_setValueToObject($use; 8; "child"; "grandchild")
$test.assert()
